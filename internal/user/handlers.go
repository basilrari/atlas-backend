...
func (h *Handlers) CreateUser(c *fiber.Ctx) error {
	...
	u, err := h.Service.CreateUser(c.Context(), CreateUserInput{
...
func (h *Handlers) UpdateRole(c *fiber.Ctx) error {
	...
	u, err := h.Service.UpdateUserRole(c.Context(), UpdateUserRoleInput{
...
func (h *Handlers) RemoveUser(c *fiber.Ctx) error {
	...
	err := h.Service.RemoveUserFromOrg(c.Context(), RemoveUserFromOrgInput{
		ActorUserID:  actor.UserID,
		ActorRole:    actor.Role,
		TargetUserID: req.UserID,
		OrgID:        actor.OrgID,
