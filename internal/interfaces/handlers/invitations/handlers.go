...
func (h *Handlers) SendInvite(c *fiber.Ctx) error {
	...
	inv, err := h.Service.SendInvite(c.Context(), invsvc.SendInviteInput{
...
func (h *Handlers) ResendInvite(c *fiber.Ctx) error {
	...
	inv, err := h.Service.ResendInvite(c.Context(), invsvc.ResendInviteInput{
		Email: body.Email,
		OrgID: actor.OrgID,
	})
	if err != nil {
...
func (h *Handlers) AcceptInvite(c *fiber.Ctx) error {
	...
	result, err := h.Service.AcceptInvite(c.Context(), invsvc.AcceptInviteInput{
		Token:  body.Token,
		UserID: actor.UserID,
	})
	if err != nil {
...
func (h *Handlers) RevokeInvite(c *fiber.Ctx) error {
	...
	inv, err := h.Service.RevokeInvite(c.Context(), invsvc.RevokeInviteInput{
		Email: body.Email,
		OrgID: actor.OrgID,
	})
	if err != nil {
...
func (h *Handlers) ListOrgInvitations(c *fiber.Ctx) error {
	...
	invitations, err := h.Service.ListOrgInvitations(c.Context(), invsvc.ListInvitesInput{
		OrgID:  actor.OrgID,
		Status: status,
	})
	if err != nil {
